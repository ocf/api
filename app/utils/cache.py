...
def cache(
    ...
    Uses Redis to achieve a shared cache across
    worker processes.
...
def _make_function_call_key(
    fn: Callable[..., Any], args: Iterable[Any], kwargs: Dict[Any, Any]
) -> Tuple[Any, ...]:
...
def periodic(
    period: float, ttl: Optional[float] = None
