...
def reset_password(data: ExpiredPasswordInput):
    try:
        ...
        validators.validate_password(data.username, data.old_password, strength_check=False)
        validators.validate_password(data.username, data.new_password, strength_check=True)
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="Please double check your credentials")
